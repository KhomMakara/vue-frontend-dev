                ...
                <b-row :gutter="16">
                    <b-col :span="6">
                        <b-form-item label="Job ID" name="jobID">
                            <template #field>
                                <b-input v-model:value="form.jobID" placeholder="Enter Job ID" />
                            </template>
                        </b-form-item>
                    </b-col>
                    <b-col :span="6">
                        <b-form-item label="Job Name" name="jobName">
                            <template #field>
                                <b-input v-model:value="form.jobName" placeholder="Enter Job Name" />
                            </template>
                        </b-form-item>
                    </b-col>
                    <b-col :span="6">
                        <b-form-item label="Execute Date" name="executeDate">
                            <template #field>
                                <b-date-picker v-model:value="form.executeDate" placeholder="Select Date" />
                            </template>
                        </b-form-item>
                    </b-col>
                    <b-col :span="6">
                        <b-form-item label="Status" name="status">
                            <template #field>
                                <b-select v-model:value="form.status" placeholder="Select Status" :allow-clear="true">
    ...
    computed: {
        ...
        rowSelection() {
            return {
                ...
                onChange: (_selectedRowKeys: string[], selectedRows: BatchJob[]) => {
